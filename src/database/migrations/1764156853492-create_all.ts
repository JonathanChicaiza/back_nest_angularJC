...
export class CreateAll1764156853492 implements MigrationInterface {
    name = 'CreateAll1764156853492'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "producto" ("id" SERIAL NOT NULL, "nombre" character varying(250) NOT NULL, "precio" numeric(10,2) NOT NULL, "stock" integer NOT NULL, "imagen" character varying(255), "descripcion" text, "estado" boolean NOT NULL DEFAULT true, "categoriaId" integer, CONSTRAINT "PK_5be023b11909fe103e24c740c7d" PRIMARY KEY ("id"))`);
